...
function getScore(sport, gameScoreObj) {
    ...
    return {
        awayTeamScore: sport === constants.MLB ? gameScoreData.lineScore.away.R : sport ===  constants.NBA ? gameScoreData.awayPts : "0",
        homeTeamScore: sport === constants.MLB ? gameScoreData.lineScore.home.R : sport ===  constants.NBA ? gameScoreData.homePts : "0",
        gameTime: gameScoreData.gameTime,
        status: sport === constants.MLB ? gameScoreData.currentInning : sport ===  constants.NBA ? gameScoreData.gameClock : "",
